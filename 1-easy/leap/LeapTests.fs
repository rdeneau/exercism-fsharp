...
[<Fact>]
let ``Year not divisible by 4 is common year`` () =
    leapYear 2015 |> should equal false

[<Fact>]
let ``Year divisible by 2, not divisible by 4 is common year`` () =
    leapYear 1970 |> should equal false

[<Fact>]
let ``Year divisible by 4, not divisible by 100 is leap year`` () =
...
[<Fact>]
let ``Year divisible by 100, not divisible by 400 is common year`` () =
...
[<Fact>]
let ``Year divisible by 200, not divisible by 400 is common year`` () =
